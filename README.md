<h1><img src="https://emojis.slackmojis.com/emojis/images/1531849430/4246/blob-sunglasses.gif?1531849430" width="30"/> Colin's Portfolio</h1> 
...
| Project Link | Area | Libraries |  Project Description |
|---|---|---|---|
|📝 [Hypothesis Testing - Men's and Women's Football Matches]([https://github.com/colinlim84/cov_corr_func/blob/main/%20Covariance%2C%20Correlation.ipynb](https://github.com/colinlim84/Hypothesis-Testing---Men-s-and-Women-s-Football-Matches/blob/main/Hypothesis%20Testing%20-%20Men's%20and%20Women's%20Football%20Matches.ipynb)) | Statistical Analysis, Hypothesis Testing | pandas, pingouin | Investigate goal-scoring patterns between men's and women's international soccer matches using official FIFA World Cup data since 2002-01-01. Analyze whether there is statistical evidence to support the hypothesis that more goals are scored in women's matches compared to men's matches. Utilize the Mann-Whitney U test due to non-normal distributions observed in goal data. |
...
| Project Link | Area | Libraries |  Project Description |
|---|---|---|---|
| 📈 [Conversion Rates Optimization](https://github.com/colinlim84/optimizing_pl_conversion/blob/main/optimizing_personal_loan_conversion_rates.ipynb) | EDA, data cleaning, imputing missing data | pandas, numpy, seaborn, matplotlib, sklearn, scipy, kneed | The bank wants to explore ways of converting its liability customers to personal loan customers (while retaining them as depositors). A campaign that the bank ran last year for liability customers showed a conversion rate of over 9% success. This has encouraged the retail marketing department to devise campaigns with better target marketing to increase the success ratio with minimal budget. |
| 📊 [Customer Segmentation Using K-Means Clustering](https://github.com/colinlim84/cm_seg_kmean/blob/main/Customer%20Segmentation%20Using%20K-Means%20Clustering.ipynb) | clustering, feature scaling,  customer segmentation, machine learning | pandas, numpy, seaborn, matplotlib, sklearn | This project aims to identify distinct customer segments based on income, age, and shopping behavior through K-Means Clustering to categorize and label key customer groups, enabling more precise marketing efforts.|
